...
</div>`}h.innerHTML=F();const g={enableTime:!0,time_24hr:!0,defaultDate:new Date,minuteIncrement:1,onClose(e){n=e[0],n<b?y.show({iconUrl:"../img/Waring.png",message:"Please choose a date in the future",messageColor:"#FFFFFF",backgroundColor:"#B51B1B",position:"topRight"}):(t.disabled=!1,t.style.background="#4E75FF",t.style.color="#FFF")}};v("#datetime-picker",g);const t=document.querySelector(".startBtn");t.disabled=!0;let a,i;t.addEventListener("click",()=>{t.disabled=!0,t.style.background="#CFCFCF",t.style.color="#989898",a=n-Date.now(),d(c(a)),i=setInterval(()=>{a-=1e3,d(c(a)),S(a)},1e3)});function S(e){e<=1e3&&clearInterval(i)}function c(e){const u=Math.floor(e/864e5),m=Math.floor(e%864e5/36e5),p=Math.floor(e%864e5%36e5/6e4),f=Math.floor(e%864e5%36e5%6e4/1e3);return{days:u,hours:m,minutes:p,seconds:f}}const C=document.querySelector(".value[ data-days]"),k=document.querySelector(".value[ data-hours]"),M=document.querySelector(".value[ data-minutes]"),q=document.querySelector(".value[ data-seconds]");function s(e){return e.toString().padStart(2,"0")}function d({days:e,hours:o,minutes:r,seconds:l}){C.textContent=`${s(e)}`,k.textContent=`${s(o)}`,M.textContent=`${s(r)}`,q.textContent=`${s(l)}`}
